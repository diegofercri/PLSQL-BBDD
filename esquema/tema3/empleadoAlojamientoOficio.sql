...
ALTER TABLE EMPLEADO
  ADD CONSTRAINT FK_ALOJAMIENTO_TO_EMPLEADO
    FOREIGN KEY (ALOJAMIENTO)
    REFERENCES ALOJAMIENTO (NUMALOJ);

ALTER TABLE OFICIOEMPLEADO
  ADD CONSTRAINT FK_EMPLEADO_TO_OFICIOEMPLEADO
    FOREIGN KEY (EMPLEADO)
    REFERENCES EMPLEADO (NUMEMP);

ALTER TABLE OFICIOEMPLEADO
  ADD CONSTRAINT FK_OFICIO_TO_OFICIOEMPLEADO
    FOREIGN KEY (OFICIO)
...
INSERT INTO OFICIO VALUES(
  1,
  'LEÑADOR',
  'MARCAR Y TALAR ARBOLES, CORTAR, APILAR'
);

INSERT INTO OFICIO VALUES(
  2,
  'CONDUCTOR DE SEGADORA',
  'CONDUCIR, AJUSTAR MAQUIA'
);

INSERT INTO OFICIO VALUES(
  3,
  'HERRERO',
  'PREPARAR FUEGO, CORTAR, HERRAR CABALLOS'
);

INSERT INTO OFICIO VALUES(
  4,
  'PICADOR',
  'CAVAR, PICAR, PALEAR, TAPAR'
);

INSERT INTO OFICIO VALUES(
  5,
  'LABRADOR',
  'APAREJAR CABALLOS, PROFUNDIDAD DE REJA'
);
...
INSERT INTO OFICIOEMPLEADO VALUES(
  1,
  6,
  'BUENO'
);
